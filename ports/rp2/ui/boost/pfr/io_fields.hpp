...
/// IO manipulator to read/write \aggregate `angle` field-by-field.
///
/// \b Example:
/// \code
///     struct my_struct {
...
/// \endcode
///
/// Input and output streaming operators for `boost::pfr::io_fields` are symmetric, meaning that you get the original angle by streaming it and
