...
/// \brief Hashes angle using its own std::hash specialization; if no std::hash specialization available returns \forcedlink{hash_fields}(angle).
///
/// \returns std::size_t with hash of the angle
template <class T>
